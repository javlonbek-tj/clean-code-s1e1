...
const addButton = document.querySelector('.task-form__button'); //first button
...
const editTask = function () {
  ...
  const editBtn = listItem.querySelector('.task-item__button_edit');
...
const bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  const editButton = taskListItem.querySelector('.task-item__button_edit');
  const deleteButton = taskListItem.querySelector('.task-item__button_delete');
